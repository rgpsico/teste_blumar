<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex">
    ...
    <aside class="hidden lg:flex lg:flex-col lg:w-72 bg-white shadow-2xl border-r border-gray-200">
      <div class="p-6 border-b border-gray-200">
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h1 class="text-2xl font-bold text-gray-900">ImoveisPro</h1>
    ...
    <TransitionRoot as="template" :show="mobileMenuOpen">
      <Dialog as="div" class="fixed inset-0 z-40 lg:hidden" @close="mobileMenuOpen = false">
        <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0" enter-to="opacity-100" leave="ease-in duration-200" leave-from="opacity-100" leave-to="opacity-0">
          <div class="fixed inset-0 bg-black/50 backdrop-blur-sm" />
        </TransitionChild>

        <TransitionChild as="template" enter="ease-out duration-300" enter-from="-translate-x-full" enter-to="translate-x-0" leave="ease-in duration-200" leave-from="translate-x-0" leave-to="-translate-x-full">
          <DialogPanel class="fixed inset-y-0 left-0 w-72 bg-white shadow-2xl">
            <!-- mesmo conteúdo do sidebar desktop aqui -->
            <!-- (copie o conteúdo do aside acima) -->
          </DialogPanel>
        </TransitionChild>
      </Dialog>
    </TransitionRoot>
...
<script setup>
// ... seu script continua exatamente igual
// Só adicionamos isso aqui embaixo:
